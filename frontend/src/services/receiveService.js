...
export const createStatus = async (statusData) => {
    try {
        const response = await axios.post(`${API_BASE_URL}/receive/create`, statusData);
...
export const getApprovedStatuses = async () => {
    try {
        const response = await axios.get(`${API_BASE_URL}/receive/approved`);
        return response.data;
    } catch (error) {
...
export const getRejectedStatuses = async () => {
    try {
        const response = await axios.get(`${API_BASE_URL}/receive/rejected`);
        return response.data;
    } catch (error) {
        throw new Error('Failed to fetch approved statuses');
    }
...
export const approveStatus = async (referenceNumber, comment, unloadingDetails, userServiceNumber, returnableItems) => {
    try {
      const response = await axios.put(`${API_BASE_URL}/receive/${referenceNumber}/approve`, { comment, unloadingDetails, userServiceNumber, returnableItems });
      return response.data;
    } catch (error) {
...
export const rejectStatus = async (referenceNumber, comment) => {
    try {
        const response = await axios.put(`${API_BASE_URL}/receive/${referenceNumber}/reject`, { comment });
        return response.data;
    } catch (error) {
